<?php
session_start();
// Security check: Uncomment when ready to enforce login
...
<body>
    ...
    <main class="admin-main">
        ...
        <div class="admin-card" style="border-top: 4px solid #0d5c34;">
            <h3 style="font-size: 1.1rem; color: #1f2937; margin-bottom: 20px;"><i class="fas fa-sliders-h"></i> Forecast Parameters</h3>
            ...
            <form action="#" method="GET">
                ...
                <div style="text-align: right; margin-top: 10px;">
                    <button type="button" class="btn-upload" style="background: #10b981;"><i class="fas fa-play"></i> Generate Forecast</button>
                </div>
            </form>
        </div>
        ...
        <div class="admin-card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                ...
                <button class="btn-upload" style="padding: 8px 15px; font-size: 0.85rem;"><i class="fas fa-file-export"></i> Export CSV</button>
            </div>
            ...
            <div style="overflow-x: auto;">
                <table class="admin-table">
                    ...
                    <tbody>
                        <tr>
                            <td>2024</td>
                            <td><span style="color: #3b82f6; font-weight: 600;">Actual</span></td>
                            <td>69.9%</td>
                            <td>-</td>
                            <td>-</td>
                        </tr>
                        <tr style="background-color: #f0fdf4;">
                            <td>2025</td>
                            <td><span style="color: #10b981; font-weight: 600;">Forecast</span></td>
                            <td><strong>69.6%</strong></td>
                            <td style="color: #6b7280;">67.1%</td>
                            <td style="color: #6b7280;">72.1%</td>
                        </tr>
                        <tr style="background-color: #f0fdf4;">
                            <td>2026</td>
                            <td><span style="color: #10b981; font-weight: 600;">Forecast</span></td>
                            <td><strong>69.6%</strong></td>
                            <td style="color: #6b7280;">65.8%</td>
                            <td style="color: #6b7280;">73.4%</td>
                        </tr>
                        <tr style="background-color: #f0fdf4;">
                            <td>2027</td>
                            <td><span style="color: #10b981; font-weight: 600;">Forecast</span></td>
                            <td><strong>69.6%</strong></td>
                            <td style="color: #6b7280;">64.2%</td>
                            <td style="color: #6b7280;">75.0%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
