...
<input type="text" name="model_name" placeholder="e.g., arima_model_2026"
...
<!-- hidden file input -->
<input type="file" id="fileInput" name="model_file" accept=".csv,.xlsx"
...
<p id="fileName" style="margin-top:12px; font-size:0.9rem; color:#374151;"></p>
...
<button type="reset" class="btn-upload"
style="background:#e5e7eb; color:#374151; margin-right:10px;">
Cancel
</button>
...
<li><i class="fas fa-check-circle" style="color:#10b981; margin-right:8px;"></i>
File must be in CSV or Excel format</li>

<li><i class="fas fa-check-circle" style="color:#10b981; margin-right:8px;"></i>
Maximum file size: 10MB</li>

<li><i class="fas fa-check-circle" style="color:#10b981; margin-right:8px;"></i>
Data must include required columns</li>
</ul>
</div>
